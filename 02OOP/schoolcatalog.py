...
ex = School("Louis Pasteur", "High", 352)
print(ex.get_name())
...
ex2 = PrimarySchool("UCLA", 150, "Pickup Forbiden")
print(ex2.get_pickUpPolicy())
print(ex2)
...
class HighSchool(School):
  ...
  def __repr__(self):
    schoolRepr = super().__repr__()
    return schoolRepr + "the sport teams available are: {sportsTeams}.".format(sportsTeams = self.sportsTeams)

ex3 = HighSchool("Bruins", 650, ["dominos", "RocketLeague", "Pokemon"])
print(ex3.get_sportsTeams())
